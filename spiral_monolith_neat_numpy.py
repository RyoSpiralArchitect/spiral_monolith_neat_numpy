...
__all__ = [
    ...
    "draw_genome_png","export_regen_gif","export_morph_gif_with_scars","export_morph_gif","export_double_exposure",
...
def export_morph_gif_with_scars(genomes: List[Genome], scars_seq: List[Dict[int, 'Scar']], out_path: str,
...
def run_backprop_neat_experiment(task: str, gens=30, pop=48, steps=40, out_prefix="out/exp", make_gifs: bool = True, make_lineage: bool = True):
    ...
    if make_gifs and len(neat.snapshots_genomes) >= 2:
        ...
        export_morph_gif_with_scars(neat.snapshots_genomes, neat.snapshots_scars, morph_gif, fps=12, morph_frames=12, decay_horizon=10.0)
    # Lineage (auto)
    lineage_path = None
    if make_lineage:
